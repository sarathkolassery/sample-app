...
<div class="input-group mb-3">
  ...
  <input type="text" class="form-control" placeholder="Enter your age" aria-label="Username" aria-describedby="basic-addon1">
</div>

<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Place</span>
  <input type="text" class="form-control" placeholder="Enter your place" aria-label="Username" aria-describedby="basic-addon1">
</div>
